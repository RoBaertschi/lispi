...
temp_allocator_get :: #force_inline proc(collisions: []runtime.Allocator, loc := #caller_location) -> Temp_Allocator {
	...
	if good_arena.backing_allocator.procedure == nil {
		good_arena.backing_allocator = os.heap_allocator()
	}
...
TEMP_ALLOCATOR_GUARD :: #force_inline proc(collisions: []runtime.Allocator, loc := #caller_location) -> Temp_Allocator {
    return temp_allocator_get(collisions, loc)
}
